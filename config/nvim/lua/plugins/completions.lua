    ...
    opts = function(_, opts)
      return vim.tbl_deep_extend('force', opts, {
        ...
        openai = {
          ...
          api_key_name = 'cmd:gopass show -n --password token/avante.openai.com', -- the shell command must prefixed with `^cmd:(.*)`
        ...
        copilot = {
          api_key_name = 'cmd:gopass show -n --password token/avante.copilot.github.com', -- the shell command must prefixed with `^cmd:(.*)`
        ...
        gemini = {
          api_key_name = 'cmd:gopass show -n --password token/avante.gemini.google.com', -- the shell command must prefixed with `^cmd:(.*)`
